...
def extract_policy_selection_adaptive_control_exchange_response_handling_contract_summaries(
    ...
    comparable_sets = [
        set_item
        for set_item in (adaptive_control_exchange_response_handling_contract_sets or [])
        if isinstance(set_item, dict)
    ]
    return [
        build_policy_selection_adaptive_control_exchange_response_handling_contract_summary(set_item)
...
def build_policy_selection_adaptive_control_exchange_response_handling_contract_set(
    ...
    comparable_summaries = [
        dict(summary)
        for summary in (adaptive_control_exchange_http_transport_contract_summaries or [])
        if isinstance(summary, dict)
    ]
    return {
        "adaptive_control_exchange_http_transport_contract_summaries": comparable_summaries,
