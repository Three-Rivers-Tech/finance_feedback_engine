...
def start_interactive_session(main_cli):
    ...
    try:
        console.print("[bold green]Welcome to the Finance Feedback Engine Interactive Shell.[/bold green]")
        console.print("Type 'menu' to list commands, 'help' for detailed help, or 'exit' to quit.\n")
        ...
        try:
            ...
            if command_name == 'help':
                if args:
                    ...
                    if target:
                        ...
                        console.print(f"[bold red]Unknown command for help: {args[0]}[/bold red]")
                else:
            ...
            if command:
                try:
                    ...
                    console.print(f"[bold red]Error: Missing parameter '{e.param.name}' for command '{command_name}'.[/bold red]")
                    ...
                    if e.code not in (0, None):
                        console.print(f"[bold red]Command exited with code {e.code}[/bold red]")
                except Exception as e:
                    console.print(f"[bold red]Unexpected error executing '{command_name}': {e}[/bold red]")
            else:
            ...
            console.print(f"[bold red]An error occurred in the interactive shell: {e}[/bold red]")
