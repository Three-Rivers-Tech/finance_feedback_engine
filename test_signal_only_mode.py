...
print(f"Stop Loss %:                {decision1['stop_loss_percentage']}")
...
print(f"Stop Loss %:                {decision2['stop_loss_percentage']}")
...
print(f"Stop Loss %:                {decision3['stop_loss_percentage']}")
...
print(f"Stop Loss %:                {decision4['stop_loss_percentage']}")
