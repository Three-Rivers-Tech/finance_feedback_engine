# Critical Bug Fixes - Finance Feedback Engine 2.0
...
git add BUGFIX_PLAN_2025-12-02.md
git commit -m "Fix 8 critical bugs - see BUGFIX_PLAN_2025-12-02.md

- Alpha Vantage client session parameter
- Market regime NumPy/Pandas type mismatch
- Vector memory missing method definition
- Coinbase product ID format
- Backtesting async/sync mismatch
...
**Next Steps:**
1. Review this plan when you return from work
