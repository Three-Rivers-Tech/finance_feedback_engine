...
def mock_config():
    ...
    return {
        ...
        "position_sizing": {"risk_percentage": 0.01, "stop_loss_percentage": 0.02},
    }
...
def mock_market_data():
    ...
    return {
        ...
        "historical_data": [
            ...
            {"close": 50400.0},
            {"close": 50200.0},
            {"close": 50000.0},  # 20 candles for SMA(20)
        ],
    }
...
def test_mock_provider_decisions(mock_config, mock_market_data):
    ...
    decision = engine.generate_decision(
        asset_pair="BTCUSD", market_data=mock_market_data, balance={"USD": 10000.0}
    )
...
def test_mock_provider_bear_market(mock_config):
    ...
    market_data = {
        ...
        "historical_data": [
            ...
            {"close": 48002.0},
            {"close": 48001.0},
            {"close": 48000.0},  # SMA(20) ~48600
        ],
    }

    decision = engine.generate_decision(
        asset_pair="BTCUSD", market_data=market_data, balance={"USD": 10000.0}
    )
...
def test_mock_provider_ranging_market(mock_config):
    ...
    market_data = {
        ...
        "historical_data": [{"close": 49500.0} for _ in range(20)],  # Flat prices
    }
