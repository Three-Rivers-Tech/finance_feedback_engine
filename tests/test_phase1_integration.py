...
def main():
    ...
    config = {
        ...
        "api_timeouts": {"market_data": 5, "sentiment": 10, "macro": 8},
    }
    ...
    invalid_decision = {"action": "MAYBE", "confidence": 150, "reasoning": ""}
    ...
    is_valid, issues = engine.data_provider.validate_market_data(valid_data, "BTCUSD")
    if is_valid:
    ...
    is_valid, issues = engine.data_provider.validate_market_data(invalid_data, "BTCUSD")
    if not is_valid:
