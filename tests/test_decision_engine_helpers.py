...
class TestSelectRelevantBalance:
    ...
    def test_crypto_asset_selects_coinbase_balance(self, decision_engine):
        ...
        balance = {"coinbase_USD": 1000.0, "oanda_USD": 2000.0}
        (
            relevant,
            source,
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "BTCUSD", "crypto")
    ...
    def test_forex_asset_selects_oanda_balance(self, decision_engine):
        ...
        (
            ...
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "EUR_USD", "forex")
    ...
    def test_btc_in_pair_detected_as_crypto(self, decision_engine):
        ...
        (
            ...
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "BTCUSD", "unknown")
        assert is_crypto is True
    ...
    def test_eth_in_pair_detected_as_crypto(self, decision_engine):
        ...
        (
            ...
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "ETHUSD", "unknown")
        assert is_crypto is True
    ...
    def test_underscore_pair_detected_as_forex(self, decision_engine):
        ...
        (
            ...
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "GBP_JPY", "unknown")
        assert is_forex is True
    ...
    def test_unknown_asset_uses_all_balances(self, decision_engine):
        ...
        balance = {"USD": 100.0, "EUR": 200.0}
        (
            relevant,
            source,
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance(balance, "UNKNOWN", "unknown")
    ...
    def test_empty_balance_returns_empty(self, decision_engine):
        ...
        (
            ...
            is_crypto,
            is_forex,
        ) = decision_engine._select_relevant_balance({}, "BTCUSD", "crypto")
        assert relevant == {}
...
class TestHasExistingPosition:
    ...
    def test_ignores_zero_amount_holding(self, decision_engine):
        ...
        portfolio = {"holdings": [{"currency": "BTC", "amount": 0}]}
        assert (
            decision_engine._has_existing_position("BTCUSD", portfolio, None) is False
        )
    ...
    def test_detects_futures_position_in_monitoring_context_list(self, decision_engine):
        ...
        monitoring_context = {"active_positions": [{"product_id": "BTC-PERP-INTX"}]}
        assert (
            decision_engine._has_existing_position(
    ...
    def test_detects_futures_position_in_monitoring_context_dict(self, decision_engine):
        ...
        monitoring_context = {
            "active_positions": {"futures": [{"product_id": "BTC-PERP-INTX"}]}
        }
        assert (
            decision_engine._has_existing_position(
                "BTC-PERP-INTX", None, monitoring_context
    ...
    def test_handles_usdt_suffix(self, decision_engine):
        ...
        portfolio = {"holdings": [{"currency": "BTC", "amount": 0.5}]}
        assert (
            decision_engine._has_existing_position("BTCUSDT", portfolio, None) is True
        )

    def test_handles_underscore_format(self, decision_engine):
        """Should handle underscore format when extracting base currency."""
        portfolio = {"holdings": [{"currency": "EUR", "amount": 1000}]}
        assert (
            decision_engine._has_existing_position("EUR_USD", portfolio, None) is True
        )
...
class TestCalculatePositionSizingParams:
    ...
    def test_normal_mode_with_valid_balance_buy(self, decision_engine):
        ...
        context = {"market_data": {"close": 50000.0}}
