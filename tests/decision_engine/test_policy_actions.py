...
def test_extract_policy_selection_provider_dispatch_contract_summaries_builds_exportable_summaries():
    summaries = extract_policy_selection_provider_dispatch_contract_summaries([
        {
            "submission_transport_envelope_summaries": [
                {
                    "summary_count": 1,
...
def test_extract_policy_selection_provider_dispatch_contract_summaries_skips_invalid_inputs():
    summaries = extract_policy_selection_provider_dispatch_contract_summaries([
        None,
        "bad",
        123,
        {"submission_transport_envelope_summaries": None},
        {"submission_transport_envelope_summaries": []},
        {
            "submission_transport_envelope_summaries": [None, 'bad', 123],
            "provider_dispatch_contract_set_version": 1,
        },
        {
            "submission_transport_envelope_summaries": [
...
def test_extract_policy_selection_provider_dispatch_contract_summaries_preserves_outcomes():
    ...
    direct = build_policy_selection_provider_dispatch_contract_summary(provider_dispatch_contract_set)
...
def test_provider_dispatch_contract_versions_align_across_export_helpers():
    provider_dispatch_contract_set = build_policy_selection_provider_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_submission_transport_envelope_count": 1,
    ...
    assert provider_dispatch_contract_set["provider_dispatch_contract_set_version"] == 1
    assert provider_dispatch_contract_summary["provider_dispatch_contract_summary_version"] == 1
    assert exported[0]["provider_dispatch_contract_summary_version"] == 1



def test_build_policy_selection_dispatch_attempt_contract_set_wraps_provider_dispatch_contract_summaries_cleanly():
    dispatch_attempt_contract_set = build_policy_selection_dispatch_attempt_contract_set([
        {
            "summary_count": 1,
            "shadow_provider_dispatch_contract_count": 1,
            "primary_cutover_provider_dispatch_contract_count": 0,
    ...
    assert dispatch_attempt_contract_set["summary_count"] == 1
    assert dispatch_attempt_contract_set["dispatch_attempt_contract_set_version"] == 1
    assert dispatch_attempt_contract_set["provider_dispatch_contract_summaries"][0]["shadow_provider_dispatch_contract_count"] == 1



def test_build_policy_selection_dispatch_attempt_contract_set_handles_empty_inputs():
    dispatch_attempt_contract_set = build_policy_selection_dispatch_attempt_contract_set([])

    assert dispatch_attempt_contract_set == {
...
def test_build_policy_selection_dispatch_attempt_contract_set_handles_none_inputs():
    dispatch_attempt_contract_set = build_policy_selection_dispatch_attempt_contract_set(None)
...
def test_build_policy_selection_dispatch_attempt_contract_set_filters_non_dict_items():
    dispatch_attempt_contract_set = build_policy_selection_dispatch_attempt_contract_set([
        {
            "summary_count": 1,
            "shadow_provider_dispatch_contract_count": 1,
    ...
    assert dispatch_attempt_contract_set["summary_count"] == 1
    assert dispatch_attempt_contract_set["provider_dispatch_contract_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_dispatch_attempt_contract_set_defensively_copies_provider_dispatch_contract_inputs():
    provider_dispatch_contract_summary = {
        "summary_count": 1,
        "shadow_provider_dispatch_contract_count": 1,
        "primary_cutover_provider_dispatch_contract_count": 0,
        "manual_hold_provider_dispatch_contract_count": 0,
    ...
    provider_dispatch_contract_summary["shadow_provider_dispatch_contract_count"] = 99

    assert dispatch_attempt_contract_set["provider_dispatch_contract_summaries"][0]["shadow_provider_dispatch_contract_count"] == 1



def test_build_policy_selection_dispatch_attempt_contract_summary_counts_outcomes_cleanly():
    ...
    assert dispatch_attempt_contract_summary == {
        "summary_count": 4,
...
def test_build_policy_selection_dispatch_attempt_contract_summary_handles_empty_inputs():
    dispatch_attempt_contract_summary = build_policy_selection_dispatch_attempt_contract_summary({
        "provider_dispatch_contract_summaries": [],
        "summary_count": 0,
        "dispatch_attempt_contract_set_version": 1,
...
def test_build_policy_selection_dispatch_attempt_contract_summary_handles_none_inputs():
    dispatch_attempt_contract_summary = build_policy_selection_dispatch_attempt_contract_summary(None)
...
def test_build_policy_selection_dispatch_attempt_contract_summary_skips_invalid_items_cleanly():
    dispatch_attempt_contract_summary = build_policy_selection_dispatch_attempt_contract_summary({
        "provider_dispatch_contract_summaries": [
            None,
            "bad",
...
def test_build_policy_selection_dispatch_attempt_contract_summary_skips_partial_inputs_cleanly():
    dispatch_attempt_contract_summary = build_policy_selection_dispatch_attempt_contract_summary({
        "provider_dispatch_contract_summaries": [
            {
                "summary_count": 1,
...
def test_dispatch_attempt_contract_versions_align_across_stage34_helpers():
    provider_dispatch_contract_summary = {
        "summary_count": 1,
        "shadow_provider_dispatch_contract_count": 1,
        "primary_cutover_provider_dispatch_contract_count": 0,
...
def test_extract_policy_selection_dispatch_attempt_contract_summaries_builds_exportable_summaries():
    summaries = extract_policy_selection_dispatch_attempt_contract_summaries([
        {
            "provider_dispatch_contract_summaries": [
                {
                    "summary_count": 1,
...
def test_extract_policy_selection_dispatch_attempt_contract_summaries_skips_invalid_inputs():
    summaries = extract_policy_selection_dispatch_attempt_contract_summaries([
        None,
        "bad",
        123,
        {"provider_dispatch_contract_summaries": None},
        {"provider_dispatch_contract_summaries": []},
        {
            "provider_dispatch_contract_summaries": [None, 'bad', 123],
            "dispatch_attempt_contract_set_version": 1,
        },
        {
            "provider_dispatch_contract_summaries": [
...
def test_extract_policy_selection_dispatch_attempt_contract_summaries_preserves_outcomes():
    ...
    direct = build_policy_selection_dispatch_attempt_contract_summary(dispatch_attempt_contract_set)
...
def test_dispatch_attempt_contract_versions_align_across_export_helpers():
    dispatch_attempt_contract_set = build_policy_selection_dispatch_attempt_contract_set([
        {
            "summary_count": 1,
            "shadow_provider_dispatch_contract_count": 1,
...
def test_build_policy_selection_execution_result_summary_counts_shadow_paths_from_dispatch_attempt_summaries():
    execution_result_set = build_policy_selection_execution_result_set([
        {
            "summary_count": 1,
            "shadow_dispatch_attempt_contract_count": 1,
...
def test_build_policy_selection_execution_result_summary_counts_primary_cutover_paths_from_dispatch_attempt_summaries():
    execution_result_set = build_policy_selection_execution_result_set([
        {
            "summary_count": 1,
            "shadow_dispatch_attempt_contract_count": 0,
...
def test_build_policy_selection_execution_result_summary_counts_manual_hold_paths_from_dispatch_attempt_summaries():
    execution_result_set = build_policy_selection_execution_result_set([
        {
            "summary_count": 1,
            "shadow_dispatch_attempt_contract_count": 0,
...
def test_build_policy_selection_execution_result_summary_defaults_to_deferred_paths_from_dispatch_attempt_summaries():
    execution_result_set = build_policy_selection_execution_result_set([
        {
            "summary_count": 1,
            "shadow_dispatch_attempt_contract_count": 0,
...
def test_build_policy_selection_execution_result_summary_handles_empty_inputs():
...
def test_build_policy_selection_execution_result_summary_skips_non_comparable_entries():
    execution_result_summary = build_policy_selection_execution_result_summary({
        "dispatch_attempt_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_execution_result_summary_round_trips_with_set_builder_and_preserves_versions():
    ...
    assert execution_result_set["execution_result_set_version"] == 1
    assert execution_result_summary["summary_count"] == 1
    assert execution_result_summary["deferred_execution_result_count"] == 1
    assert execution_result_summary["execution_result_summary_version"] == 1



def test_build_policy_selection_execution_result_summary_matches_direct_and_export_ready_counts():
    dispatch_attempt_contract_summary = {
        "summary_count": 1,
        "shadow_dispatch_attempt_contract_count": 1,
        "primary_cutover_dispatch_attempt_contract_count": 0,
...
def test_build_policy_selection_execution_result_summary_accumulates_multiple_comparable_entries():
    execution_result_set = build_policy_selection_execution_result_set([
        {
            "summary_count": 1,
            "shadow_dispatch_attempt_contract_count": 1,
...
def test_build_policy_selection_execution_receipt_set_wraps_execution_result_summaries_cleanly():
    ...
    assert execution_receipt_set["summary_count"] == 1
    assert execution_receipt_set["execution_receipt_set_version"] == 1
    assert execution_receipt_set["execution_result_summaries"][0]["shadow_execution_result_count"] == 1



def test_build_policy_selection_execution_receipt_set_handles_empty_inputs():
    execution_receipt_set = build_policy_selection_execution_receipt_set([])

    assert execution_receipt_set == {
...
def test_build_policy_selection_execution_receipt_set_handles_none_inputs():
    execution_receipt_set = build_policy_selection_execution_receipt_set(None)
...
def test_build_policy_selection_execution_receipt_set_filters_non_dict_items():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        None,
        "skip",
        7,
    ...
    assert execution_receipt_set["summary_count"] == 1
    assert execution_receipt_set["execution_result_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_execution_receipt_set_defensively_copies_execution_result_inputs():
    summary = {
        "summary_count": 1,
        "shadow_execution_result_count": 1,
        "primary_cutover_execution_result_count": 0,
    ...
    execution_receipt_set = build_policy_selection_execution_receipt_set([summary])
    summary["shadow_execution_result_count"] = 99

    assert execution_receipt_set["execution_result_summaries"][0]["shadow_execution_result_count"] == 1



def test_build_policy_selection_execution_receipt_summary_counts_shadow_paths_from_execution_result_summaries():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 1,
...
def test_build_policy_selection_execution_receipt_summary_counts_primary_cutover_paths_from_execution_result_summaries():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 0,
...
def test_build_policy_selection_execution_receipt_summary_counts_manual_hold_paths_from_execution_result_summaries():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 0,
...
def test_build_policy_selection_execution_receipt_summary_defaults_to_deferred_paths_from_execution_result_summaries():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 0,
...
def test_build_policy_selection_execution_receipt_summary_handles_empty_inputs():
...
def test_build_policy_selection_execution_receipt_summary_skips_non_comparable_entries():
    execution_receipt_summary = build_policy_selection_execution_receipt_summary({
        "execution_result_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_execution_receipt_summary_round_trips_with_set_builder_and_preserves_versions():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 0,
    ...
    assert execution_receipt_set["execution_receipt_set_version"] == 1
    assert execution_receipt_summary["summary_count"] == 1
    assert execution_receipt_summary["deferred_execution_receipt_count"] == 1
    assert execution_receipt_summary["execution_receipt_summary_version"] == 1



def test_build_policy_selection_execution_receipt_summary_matches_direct_and_export_ready_counts():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 1,
    ...
    direct = build_policy_selection_execution_receipt_summary(execution_receipt_set)
...
def test_build_policy_selection_execution_receipt_summary_accumulates_multiple_comparable_entries():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 1,
...
def test_extract_policy_selection_execution_receipt_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    ...
    direct = build_policy_selection_execution_receipt_summary(execution_receipt_set)
    exported = extract_policy_selection_execution_receipt_summaries([None, "skip", execution_receipt_set, {"execution_result_summaries": []}])

    assert exported == [direct]



def test_extract_policy_selection_execution_receipt_summaries_preserves_deferred_counts_for_export():
    execution_receipt_set = build_policy_selection_execution_receipt_set([
        {
            "summary_count": 1,
            "shadow_execution_result_count": 0,
...
def test_build_policy_selection_execution_tracking_summary_counts_shadow_paths_from_execution_receipt_summaries():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 1,
    ...
    assert execution_tracking_summary == {
        "summary_count": 1,
...
def test_build_policy_selection_execution_tracking_summary_counts_primary_cutover_paths_from_execution_receipt_summaries():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 0,
...
def test_build_policy_selection_execution_tracking_summary_counts_manual_hold_paths_from_execution_receipt_summaries():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 0,
...
def test_build_policy_selection_execution_tracking_summary_defaults_to_deferred_paths_from_execution_receipt_summaries():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 0,
...
def test_build_policy_selection_execution_tracking_summary_handles_empty_inputs():
...
def test_build_policy_selection_execution_tracking_summary_skips_non_comparable_entries():
    execution_tracking_summary = build_policy_selection_execution_tracking_summary({
        "execution_receipt_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_execution_tracking_summary_round_trips_with_set_builder_and_preserves_versions():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 0,
    ...
    assert execution_tracking_set["execution_tracking_set_version"] == 1
    assert execution_tracking_summary["summary_count"] == 1
    assert execution_tracking_summary["deferred_execution_tracking_count"] == 1
    assert execution_tracking_summary["execution_tracking_summary_version"] == 1



def test_build_policy_selection_execution_tracking_summary_matches_direct_and_export_ready_counts():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 1,
...
def test_build_policy_selection_execution_tracking_summary_accumulates_multiple_comparable_entries():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 1,
...
def test_execution_tracking_chain_preserves_shadow_path_from_execution_receipt_summary():
...
def test_execution_tracking_chain_preserves_manual_hold_and_deferred_mix_from_execution_receipt_summaries():
    execution_receipt_summaries = [
        {
            "summary_count": 1,
            "shadow_execution_receipt_count": 0,
    ...
    execution_tracking_set = build_policy_selection_execution_tracking_set(execution_receipt_summaries)
    execution_tracking_summary = build_policy_selection_execution_tracking_summary(execution_tracking_set)

    assert execution_tracking_set["summary_count"] == 2
    assert execution_tracking_summary == {
        "summary_count": 2,
        "shadow_execution_tracking_count": 0,
        "primary_cutover_execution_tracking_count": 0,
...
def test_execution_tracking_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    execution_tracking_set = build_policy_selection_execution_tracking_set([
        {
            "summary_count": 0,
            "shadow_execution_receipt_count": 1,
...
def test_build_policy_selection_execution_fill_set_wraps_execution_tracking_summaries_cleanly():
    ...
    assert execution_fill_set["summary_count"] == 1
    assert execution_fill_set["execution_fill_set_version"] == 1
    assert execution_fill_set["execution_tracking_summaries"][0]["shadow_execution_tracking_count"] == 1



def test_build_policy_selection_execution_fill_set_handles_empty_inputs():
    execution_fill_set = build_policy_selection_execution_fill_set([])

    assert execution_fill_set == {
...
def test_build_policy_selection_execution_fill_set_handles_none_inputs():
    execution_fill_set = build_policy_selection_execution_fill_set(None)
...
def test_build_policy_selection_execution_fill_set_filters_non_dict_items():
    execution_fill_set = build_policy_selection_execution_fill_set([
        None,
        "skip",
        7,
    ...
    assert execution_fill_set["summary_count"] == 1
    assert execution_fill_set["execution_tracking_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_execution_fill_set_defensively_copies_execution_tracking_inputs():
    summary = {
        "summary_count": 1,
        "shadow_execution_tracking_count": 1,
        "primary_cutover_execution_tracking_count": 0,
    ...
    execution_fill_set = build_policy_selection_execution_fill_set([summary])
    summary["shadow_execution_tracking_count"] = 99

    assert execution_fill_set["execution_tracking_summaries"][0]["shadow_execution_tracking_count"] == 1



def test_build_policy_selection_execution_fill_summary_counts_shadow_paths_from_execution_tracking_summaries():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 1,
...
def test_build_policy_selection_execution_fill_summary_counts_primary_cutover_paths_from_execution_tracking_summaries():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 0,
...
def test_build_policy_selection_execution_fill_summary_counts_manual_hold_paths_from_execution_tracking_summaries():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 0,
...
def test_build_policy_selection_execution_fill_summary_defaults_to_deferred_paths_from_execution_tracking_summaries():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 0,
...
def test_build_policy_selection_execution_fill_summary_handles_empty_inputs():
...
def test_build_policy_selection_execution_fill_summary_skips_non_comparable_entries():
    execution_fill_summary = build_policy_selection_execution_fill_summary({
        "execution_tracking_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_execution_fill_summary_round_trips_with_set_builder_and_preserves_versions():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 0,
    ...
    assert execution_fill_set["execution_fill_set_version"] == 1
    assert execution_fill_summary["summary_count"] == 1
    assert execution_fill_summary["deferred_execution_fill_count"] == 1
    assert execution_fill_summary["execution_fill_summary_version"] == 1



def test_build_policy_selection_execution_fill_summary_matches_direct_and_export_ready_counts():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 1,
    ...
    direct = build_policy_selection_execution_fill_summary(execution_fill_set)
...
def test_build_policy_selection_execution_fill_summary_accumulates_multiple_comparable_entries():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 1,
...
def test_extract_policy_selection_execution_fill_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    execution_fill_set = {
        "execution_tracking_summaries": [
            {
                "summary_count": 1,
    ...
    direct = build_policy_selection_execution_fill_summary(execution_fill_set)
    exported = extract_policy_selection_execution_fill_summaries([None, "skip", execution_fill_set, {"execution_tracking_summaries": []}])

    assert exported == [direct]



def test_extract_policy_selection_execution_fill_summaries_preserves_deferred_counts_for_export():
    execution_fill_set = build_policy_selection_execution_fill_set([
        {
            "summary_count": 1,
            "shadow_execution_tracking_count": 0,
...
def test_trade_outcome_chain_preserves_shadow_path_from_execution_fill_summary():
...
def test_trade_outcome_chain_preserves_manual_hold_and_deferred_mix_from_execution_fill_summaries():
    execution_fill_summaries = [
        {
            "summary_count": 1,
            "shadow_execution_fill_count": 0,
    ...
    trade_outcome_set = build_policy_selection_trade_outcome_set(execution_fill_summaries)
    trade_outcome_summary = build_policy_selection_trade_outcome_summary(trade_outcome_set)

    assert trade_outcome_set["summary_count"] == 2
    assert trade_outcome_summary == {
        "summary_count": 2,
        "shadow_trade_outcome_count": 0,
        "primary_cutover_trade_outcome_count": 0,
...
def test_trade_outcome_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    trade_outcome_set = build_policy_selection_trade_outcome_set([
        {
            "summary_count": 0,
            "shadow_execution_fill_count": 1,
...
def test_build_policy_selection_learning_feedback_summary_counts_shadow_paths_from_trade_outcome_summaries():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 1,
...
def test_build_policy_selection_learning_feedback_summary_counts_primary_cutover_paths_from_trade_outcome_summaries():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 0,
...
def test_build_policy_selection_learning_feedback_summary_counts_manual_hold_paths_from_trade_outcome_summaries():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 0,
...
def test_build_policy_selection_learning_feedback_summary_defaults_to_deferred_paths_from_trade_outcome_summaries():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 0,
...
def test_build_policy_selection_learning_feedback_summary_handles_empty_inputs():
...
def test_build_policy_selection_learning_feedback_summary_skips_non_comparable_entries():
    learning_feedback_summary = build_policy_selection_learning_feedback_summary({
        "trade_outcome_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_learning_feedback_summary_round_trips_with_set_builder_and_preserves_versions():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 0,
    ...
    assert learning_feedback_set["learning_feedback_set_version"] == 1
    assert learning_feedback_summary["summary_count"] == 1
    assert learning_feedback_summary["deferred_learning_feedback_count"] == 1
    assert learning_feedback_summary["learning_feedback_summary_version"] == 1



def test_build_policy_selection_learning_feedback_summary_matches_direct_and_export_ready_counts():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 1,
...
def test_build_policy_selection_learning_feedback_summary_accumulates_multiple_comparable_entries():
    learning_feedback_set = build_policy_selection_learning_feedback_set([
        {
            "summary_count": 1,
            "shadow_trade_outcome_count": 1,
...
def test_build_policy_selection_learning_analytics_summary_counts_shadow_paths_from_learning_feedback_summaries():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 1,
...
def test_build_policy_selection_learning_analytics_summary_counts_primary_cutover_paths_from_learning_feedback_summaries():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 0,
...
def test_build_policy_selection_learning_analytics_summary_counts_manual_hold_paths_from_learning_feedback_summaries():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 0,
...
def test_build_policy_selection_learning_analytics_summary_defaults_to_deferred_paths_from_learning_feedback_summaries():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 0,
...
def test_build_policy_selection_learning_analytics_summary_handles_empty_inputs():
...
def test_build_policy_selection_learning_analytics_summary_skips_non_comparable_entries():
    learning_analytics_summary = build_policy_selection_learning_analytics_summary({
        "learning_feedback_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_learning_analytics_summary_round_trips_with_set_builder_and_preserves_versions():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 0,
    ...
    assert learning_analytics_set["learning_analytics_set_version"] == 1
    assert learning_analytics_summary["summary_count"] == 1
    assert learning_analytics_summary["deferred_learning_analytics_count"] == 1
    assert learning_analytics_summary["learning_analytics_summary_version"] == 1



def test_build_policy_selection_learning_analytics_summary_matches_direct_and_export_ready_counts():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 1,
    ...
    direct = build_policy_selection_learning_analytics_summary(learning_analytics_set)
...
def test_build_policy_selection_learning_analytics_summary_accumulates_multiple_comparable_entries():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 1,
...
def test_extract_policy_selection_learning_analytics_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    ...
    direct = build_policy_selection_learning_analytics_summary(learning_analytics_set)
    exported = extract_policy_selection_learning_analytics_summaries([None, "skip", learning_analytics_set, {"learning_feedback_summaries": []}])

    assert exported == [direct]



def test_extract_policy_selection_learning_analytics_summaries_preserves_deferred_counts_for_export():
    learning_analytics_set = build_policy_selection_learning_analytics_set([
        {
            "summary_count": 1,
            "shadow_learning_feedback_count": 0,
...
def test_adaptive_recommendation_chain_preserves_shadow_path_from_learning_analytics_summary():
...
def test_adaptive_recommendation_chain_preserves_manual_hold_and_deferred_mix_from_learning_analytics_summaries():
    learning_analytics_summaries = [
        {
            "summary_count": 1,
            "shadow_learning_analytics_count": 0,
    ...
    adaptive_recommendation_set = build_policy_selection_adaptive_recommendation_set(learning_analytics_summaries)
    adaptive_recommendation_summary = build_policy_selection_adaptive_recommendation_summary(adaptive_recommendation_set)

    assert adaptive_recommendation_set["summary_count"] == 2
    assert adaptive_recommendation_summary == {
        "summary_count": 2,
        "shadow_adaptive_recommendation_count": 0,
        "primary_cutover_adaptive_recommendation_count": 0,
...
def test_adaptive_recommendation_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    adaptive_recommendation_set = build_policy_selection_adaptive_recommendation_set([
        {
            "summary_count": 0,
            "shadow_learning_analytics_count": 1,
...
def test_build_policy_selection_adaptive_activation_summary_counts_shadow_paths_from_adaptive_recommendation_summaries():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 1,
...
def test_build_policy_selection_adaptive_activation_summary_counts_primary_cutover_paths_from_adaptive_recommendation_summaries():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 0,
...
def test_build_policy_selection_adaptive_activation_summary_counts_manual_hold_paths_from_adaptive_recommendation_summaries():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 0,
...
def test_build_policy_selection_adaptive_activation_summary_defaults_to_deferred_paths_from_adaptive_recommendation_summaries():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 0,
...
def test_build_policy_selection_adaptive_activation_summary_handles_empty_inputs():
...
def test_build_policy_selection_adaptive_activation_summary_skips_non_comparable_entries():
    adaptive_activation_summary = build_policy_selection_adaptive_activation_summary({
        "adaptive_recommendation_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_activation_summary_round_trips_with_set_builder_and_preserves_versions():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 0,
    ...
    assert adaptive_activation_set["adaptive_activation_set_version"] == 1
    assert adaptive_activation_summary["summary_count"] == 1
    assert adaptive_activation_summary["deferred_adaptive_activation_count"] == 1
    assert adaptive_activation_summary["adaptive_activation_summary_version"] == 1



def test_build_policy_selection_adaptive_activation_summary_matches_direct_and_export_ready_counts():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 1,
...
def test_build_policy_selection_adaptive_activation_summary_accumulates_multiple_comparable_entries():
    adaptive_activation_set = build_policy_selection_adaptive_activation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_recommendation_count": 1,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_counts_shadow_paths_from_adaptive_activation_summaries():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 1,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_counts_primary_cutover_paths_from_adaptive_activation_summaries():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 0,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_counts_manual_hold_paths_from_adaptive_activation_summaries():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 0,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_defaults_to_deferred_paths_from_adaptive_activation_summaries():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 0,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_handles_empty_inputs():
...
def test_build_policy_selection_adaptive_weight_mutation_summary_skips_non_comparable_entries():
    adaptive_weight_mutation_summary = build_policy_selection_adaptive_weight_mutation_summary({
        "adaptive_activation_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_weight_mutation_summary_round_trips_with_set_builder_and_preserves_versions():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 0,
    ...
    assert adaptive_weight_mutation_set["adaptive_weight_mutation_set_version"] == 1
    assert adaptive_weight_mutation_summary["summary_count"] == 1
    assert adaptive_weight_mutation_summary["deferred_adaptive_weight_mutation_count"] == 1
    assert adaptive_weight_mutation_summary["adaptive_weight_mutation_summary_version"] == 1



def test_build_policy_selection_adaptive_weight_mutation_summary_matches_direct_and_export_ready_counts():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 1,
...
def test_build_policy_selection_adaptive_weight_mutation_summary_accumulates_multiple_comparable_entries():
    adaptive_weight_mutation_set = build_policy_selection_adaptive_weight_mutation_set([
        {
            "summary_count": 1,
            "shadow_adaptive_activation_count": 1,
...
def test_build_policy_selection_adaptive_control_persistence_set_wraps_adaptive_weight_mutation_summaries_cleanly():
    ...
    assert adaptive_control_persistence_set["summary_count"] == 1
...
def test_build_policy_selection_adaptive_control_persistence_set_handles_empty_inputs():
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set([])

    assert adaptive_control_persistence_set == {
...
def test_build_policy_selection_adaptive_control_persistence_set_handles_none_inputs():
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set(None)
...
def test_build_policy_selection_adaptive_control_persistence_set_filters_non_dict_items():
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set([
        None,
        "skip",
        7,
    ...
    assert adaptive_control_persistence_set["summary_count"] == 1
    assert adaptive_control_persistence_set["adaptive_weight_mutation_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_adaptive_control_persistence_set_defensively_copies_adaptive_weight_mutation_inputs():
    summary = {
        "summary_count": 1,
        "shadow_adaptive_weight_mutation_count": 1,
        "primary_cutover_adaptive_weight_mutation_count": 0,
    ...
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set([summary])
...
def test_adaptive_control_persistence_chain_preserves_shadow_path_from_adaptive_weight_mutation_summary():
    adaptive_weight_mutation_summary = {
        "summary_count": 1,
        "shadow_adaptive_weight_mutation_count": 1,
        "primary_cutover_adaptive_weight_mutation_count": 0,
        "manual_hold_adaptive_weight_mutation_count": 0,
...
def test_adaptive_control_persistence_chain_preserves_manual_hold_and_deferred_mix_from_adaptive_weight_mutation_summaries():
    adaptive_weight_mutation_summaries = [
        {
            "summary_count": 1,
            "shadow_adaptive_weight_mutation_count": 0,
    ...
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set(adaptive_weight_mutation_summaries)
    adaptive_control_persistence_summary = build_policy_selection_adaptive_control_persistence_summary(adaptive_control_persistence_set)

    assert adaptive_control_persistence_set["summary_count"] == 2
    assert adaptive_control_persistence_summary == {
        "summary_count": 2,
        "shadow_adaptive_control_persistence_count": 0,
        "primary_cutover_adaptive_control_persistence_count": 0,
...
def test_adaptive_control_persistence_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    adaptive_control_persistence_set = build_policy_selection_adaptive_control_persistence_set([
        {
            "summary_count": 0,
            "shadow_adaptive_weight_mutation_count": 1,
...
def test_build_policy_selection_adaptive_control_snapshot_set_wraps_adaptive_control_persistence_summaries_cleanly():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 1,
            "primary_cutover_adaptive_control_persistence_count": 0,
    ...
    assert adaptive_control_snapshot_set["summary_count"] == 1
    assert adaptive_control_snapshot_set["adaptive_control_snapshot_set_version"] == 1
    assert adaptive_control_snapshot_set["adaptive_control_persistence_summaries"][0]["shadow_adaptive_control_persistence_count"] == 1



def test_build_policy_selection_adaptive_control_snapshot_set_handles_empty_inputs():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([])

    assert adaptive_control_snapshot_set == {
...
def test_build_policy_selection_adaptive_control_snapshot_set_handles_none_inputs():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set(None)
...
def test_build_policy_selection_adaptive_control_snapshot_set_filters_non_dict_items():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        None,
        "skip",
        7,
    ...
    assert adaptive_control_snapshot_set["summary_count"] == 1
    assert adaptive_control_snapshot_set["adaptive_control_persistence_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_adaptive_control_snapshot_set_defensively_copies_adaptive_control_persistence_inputs():
    summary = {
        "summary_count": 1,
        "shadow_adaptive_control_persistence_count": 1,
        "primary_cutover_adaptive_control_persistence_count": 0,
    ...
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([summary])
    summary["shadow_adaptive_control_persistence_count"] = 99

    assert adaptive_control_snapshot_set["adaptive_control_persistence_summaries"][0]["shadow_adaptive_control_persistence_count"] == 1



def test_build_policy_selection_adaptive_control_snapshot_summary_counts_shadow_paths_from_adaptive_control_persistence_summaries():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 1,
    ...
    assert adaptive_control_snapshot_summary == {
        "summary_count": 1,
...
def test_build_policy_selection_adaptive_control_snapshot_summary_counts_primary_cutover_paths_from_adaptive_control_persistence_summaries():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 0,
...
def test_build_policy_selection_adaptive_control_snapshot_summary_counts_manual_hold_paths_from_adaptive_control_persistence_summaries():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 0,
...
def test_build_policy_selection_adaptive_control_snapshot_summary_defaults_to_deferred_paths_from_adaptive_control_persistence_summaries():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 0,
...
def test_build_policy_selection_adaptive_control_snapshot_summary_handles_empty_inputs():
    adaptive_control_snapshot_summary = build_policy_selection_adaptive_control_snapshot_summary({})
...
def test_build_policy_selection_adaptive_control_snapshot_summary_skips_non_comparable_entries():
    adaptive_control_snapshot_summary = build_policy_selection_adaptive_control_snapshot_summary({
        "adaptive_control_persistence_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_snapshot_summary_round_trips_with_set_builder_and_preserves_versions():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 0,
    ...
    assert adaptive_control_snapshot_set["adaptive_control_snapshot_set_version"] == 1
    assert adaptive_control_snapshot_summary["summary_count"] == 1
    assert adaptive_control_snapshot_summary["deferred_adaptive_control_snapshot_count"] == 1
    assert adaptive_control_snapshot_summary["adaptive_control_snapshot_summary_version"] == 1



def test_build_policy_selection_adaptive_control_snapshot_summary_matches_direct_and_export_ready_counts():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 1,
    ...
    direct = build_policy_selection_adaptive_control_snapshot_summary(adaptive_control_snapshot_set)
...
def test_build_policy_selection_adaptive_control_snapshot_summary_accumulates_multiple_comparable_entries():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 1,
...
def test_adaptive_control_snapshot_chain_preserves_shadow_path_from_adaptive_control_persistence_summary():
    adaptive_control_persistence_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_persistence_count": 1,
        "primary_cutover_adaptive_control_persistence_count": 0,
        "manual_hold_adaptive_control_persistence_count": 0,
...
def test_adaptive_control_snapshot_chain_preserves_manual_hold_and_deferred_mix_from_adaptive_control_persistence_summaries():
    adaptive_control_persistence_summaries = [
        {
            "summary_count": 1,
            "shadow_adaptive_control_persistence_count": 0,
    ...
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set(adaptive_control_persistence_summaries)
    adaptive_control_snapshot_summary = build_policy_selection_adaptive_control_snapshot_summary(adaptive_control_snapshot_set)

    assert adaptive_control_snapshot_set["summary_count"] == 2
    assert adaptive_control_snapshot_summary == {
        "summary_count": 2,
        "shadow_adaptive_control_snapshot_count": 0,
        "primary_cutover_adaptive_control_snapshot_count": 0,
...
def test_adaptive_control_snapshot_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    adaptive_control_snapshot_set = build_policy_selection_adaptive_control_snapshot_set([
        {
            "summary_count": 0,
            "shadow_adaptive_control_persistence_count": 1,
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_counts_shadow_paths_from_adaptive_control_snapshot_summaries():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 1,
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_counts_primary_cutover_paths_from_adaptive_control_snapshot_summaries():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_counts_manual_hold_paths_from_adaptive_control_snapshot_summaries():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_defaults_to_deferred_paths_from_adaptive_control_snapshot_summaries():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_handles_empty_inputs():
    adaptive_control_runtime_apply_summary = build_policy_selection_adaptive_control_runtime_apply_summary({})
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_skips_non_comparable_entries():
    adaptive_control_runtime_apply_summary = build_policy_selection_adaptive_control_runtime_apply_summary({
        "adaptive_control_snapshot_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_round_trips_with_set_builder_and_preserves_versions():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 0,
    ...
    assert adaptive_control_runtime_apply_set["adaptive_control_runtime_apply_set_version"] == 1
    assert adaptive_control_runtime_apply_summary["summary_count"] == 1
    assert adaptive_control_runtime_apply_summary["deferred_adaptive_control_runtime_apply_count"] == 1
    assert adaptive_control_runtime_apply_summary["adaptive_control_runtime_apply_summary_version"] == 1



def test_build_policy_selection_adaptive_control_runtime_apply_summary_matches_direct_and_export_ready_counts():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 1,
    ...
    direct = build_policy_selection_adaptive_control_runtime_apply_summary(adaptive_control_runtime_apply_set)
...
def test_build_policy_selection_adaptive_control_runtime_apply_summary_accumulates_multiple_comparable_entries():
    adaptive_control_runtime_apply_set = build_policy_selection_adaptive_control_runtime_apply_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_snapshot_count": 1,
...
def test_extract_policy_selection_adaptive_control_runtime_apply_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    adaptive_control_runtime_apply_summaries = extract_policy_selection_adaptive_control_runtime_apply_summaries([
        None,
        "skip",
        {
            "adaptive_control_snapshot_summaries": [
    ...
    assert adaptive_control_runtime_apply_summaries == [
        {
            "summary_count": 1,
            "shadow_adaptive_control_runtime_apply_count": 1,
            "primary_cutover_adaptive_control_runtime_apply_count": 0,
...
def test_extract_policy_selection_adaptive_control_runtime_apply_summaries_preserves_deferred_counts_for_export():
    adaptive_control_runtime_apply_summaries = extract_policy_selection_adaptive_control_runtime_apply_summaries([
        {
            "adaptive_control_snapshot_summaries": [
                {
...
def test_build_policy_selection_adaptive_control_config_patch_contract_set_wraps_adaptive_control_runtime_apply_summaries_cleanly():
    ...
    assert adaptive_control_config_patch_contract_set["summary_count"] == 1
...
def test_build_policy_selection_adaptive_control_config_patch_contract_set_handles_empty_inputs():
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set([])

    assert adaptive_control_config_patch_contract_set == {
...
def test_build_policy_selection_adaptive_control_config_patch_contract_set_handles_none_inputs():
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set(None)
...
def test_build_policy_selection_adaptive_control_config_patch_contract_set_filters_non_dict_items():
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set([
        None,
        "skip",
        7,
    ...
    assert adaptive_control_config_patch_contract_set["summary_count"] == 1
    assert adaptive_control_config_patch_contract_set["adaptive_control_runtime_apply_summaries"][0]["summary_count"] == 1



def test_build_policy_selection_adaptive_control_config_patch_contract_set_defensively_copies_adaptive_control_runtime_apply_inputs():
    summary = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_apply_count": 1,
        "primary_cutover_adaptive_control_runtime_apply_count": 0,
    ...
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set([summary])
...
def test_adaptive_control_config_patch_contract_chain_preserves_shadow_path_from_adaptive_control_runtime_apply_summary():
    adaptive_control_runtime_apply_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_apply_count": 1,
        "primary_cutover_adaptive_control_runtime_apply_count": 0,
        "manual_hold_adaptive_control_runtime_apply_count": 0,
...
def test_adaptive_control_config_patch_contract_chain_preserves_manual_hold_and_deferred_mix_from_adaptive_control_runtime_apply_summaries():
    adaptive_control_runtime_apply_summaries = [
        {
            "summary_count": 1,
            "shadow_adaptive_control_runtime_apply_count": 0,
    ...
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set(adaptive_control_runtime_apply_summaries)
    adaptive_control_config_patch_contract_summary = build_policy_selection_adaptive_control_config_patch_contract_summary(adaptive_control_config_patch_contract_set)

    assert adaptive_control_config_patch_contract_set["summary_count"] == 2
    assert adaptive_control_config_patch_contract_summary == {
        "summary_count": 2,
        "shadow_adaptive_control_config_patch_contract_count": 0,
        "primary_cutover_adaptive_control_config_patch_contract_count": 0,
...
def test_adaptive_control_config_patch_contract_chain_skips_non_comparable_upstream_summaries_without_mutating_versions():
    adaptive_control_config_patch_contract_set = build_policy_selection_adaptive_control_config_patch_contract_set([
        {
            "summary_count": 0,
            "shadow_adaptive_control_runtime_apply_count": 1,
...
def test_extract_policy_selection_adaptive_control_config_patch_contract_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    adaptive_control_config_patch_contract_summaries = extract_policy_selection_adaptive_control_config_patch_contract_summaries([
        None,
        "skip",
        {
            "adaptive_control_runtime_apply_summaries": [
    ...
    assert adaptive_control_config_patch_contract_summaries == [
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 1,
            "primary_cutover_adaptive_control_config_patch_contract_count": 0,
...
def test_extract_policy_selection_adaptive_control_config_patch_contract_summaries_preserves_deferred_counts_for_export():
    adaptive_control_config_patch_contract_summaries = extract_policy_selection_adaptive_control_config_patch_contract_summaries([
        {
            "adaptive_control_runtime_apply_summaries": [
                {
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_counts_shadow_paths_from_adaptive_control_config_patch_contract_summaries():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 1,
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_counts_primary_cutover_paths_from_adaptive_control_config_patch_contract_summaries():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_counts_manual_hold_paths_from_adaptive_control_config_patch_contract_summaries():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_defaults_to_deferred_paths_from_adaptive_control_config_patch_contract_summaries():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_handles_empty_inputs():
    adaptive_control_runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary({})
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_skips_non_comparable_entries():
    adaptive_control_runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary({
        "adaptive_control_config_patch_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_round_trips_with_set_builder_and_preserves_versions():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 0,
    ...
    assert adaptive_control_runtime_config_materialization_set["adaptive_control_runtime_config_materialization_set_version"] == 1
    assert adaptive_control_runtime_config_materialization_summary["summary_count"] == 1
    assert adaptive_control_runtime_config_materialization_summary["deferred_adaptive_control_runtime_config_materialization_count"] == 1
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_matches_direct_and_export_ready_counts():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 1,
    ...
    direct = build_policy_selection_adaptive_control_runtime_config_materialization_summary(adaptive_control_runtime_config_materialization_set)
...
def test_build_policy_selection_adaptive_control_runtime_config_materialization_summary_accumulates_multiple_comparable_entries():
    adaptive_control_runtime_config_materialization_set = build_policy_selection_adaptive_control_runtime_config_materialization_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_patch_contract_count": 1,
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_set_wraps_runtime_config_materialization_summaries_cleanly():
    runtime_config_materialization_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_config_materialization_count": 0,
        "primary_cutover_adaptive_control_runtime_config_materialization_count": 1,
        "manual_hold_adaptive_control_runtime_config_materialization_count": 0,
    ...
    result = build_policy_selection_adaptive_control_config_update_transport_contract_set(
        [runtime_config_materialization_summary]
    )

    assert result == {
        "adaptive_control_runtime_config_materialization_summaries": [runtime_config_materialization_summary],
        "adaptive_control_config_update_transport_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_config_update_transport_contract_set_filters_non_mapping_entries():
    runtime_config_materialization_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_config_materialization_count": 1,
        "primary_cutover_adaptive_control_runtime_config_materialization_count": 0,
    ...
    result = build_policy_selection_adaptive_control_config_update_transport_contract_set(
        [runtime_config_materialization_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_config_update_transport_contract_set(None)
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_config_materialization_count": 0,
        "primary_cutover_adaptive_control_runtime_config_materialization_count": 0,
    ...
    result = build_policy_selection_adaptive_control_config_update_transport_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_runtime_config_materialization_count"] = 99
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_set_preserves_multiple_runtime_config_materialization_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_runtime_config_materialization_count": 1,
        "primary_cutover_adaptive_control_runtime_config_materialization_count": 0,
    ...
    result = build_policy_selection_adaptive_control_config_update_transport_contract_set([first, second])
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_summary_chain_progresses_runtime_config_materialization_outputs_end_to_end():
    runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary(
        build_policy_selection_adaptive_control_runtime_config_materialization_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_patch_contract_count": 0,
    ...
    assert transport_contract_set == {
        "adaptive_control_runtime_config_materialization_summaries": [runtime_config_materialization_summary],
        "adaptive_control_config_update_transport_contract_set_version": 1,
    }
    assert transport_contract_summary == {
        "summary_count": 1,
        "shadow_adaptive_control_config_update_transport_contract_count": 0,
        "primary_cutover_adaptive_control_config_update_transport_contract_count": 1,
        "manual_hold_adaptive_control_config_update_transport_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_summary_chain_handles_mixed_transport_path_counts():
    first_runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary(
        build_policy_selection_adaptive_control_runtime_config_materialization_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_patch_contract_count": 1,
    ...
    second_runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary(
        build_policy_selection_adaptive_control_runtime_config_materialization_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_patch_contract_count": 0,
    ...
    transport_contract_summary = build_policy_selection_adaptive_control_config_update_transport_contract_summary(
        build_policy_selection_adaptive_control_config_update_transport_contract_set([
            first_runtime_config_materialization_summary,
            second_runtime_config_materialization_summary,
        ])
    )
...
def test_build_policy_selection_adaptive_control_config_update_transport_contract_summary_chain_preserves_deferred_counts_for_downstream_export():
    runtime_config_materialization_summary = build_policy_selection_adaptive_control_runtime_config_materialization_summary(
        build_policy_selection_adaptive_control_runtime_config_materialization_set([
            {
                "summary_count": 1,
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_counts_shadow_paths_from_config_update_transport_contract_summaries():
    ...
    summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary(lifecycle_control_contract_set)
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_counts_primary_cutover_paths_from_config_update_transport_contract_summaries():
    lifecycle_control_contract_set = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_update_transport_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_counts_manual_hold_paths_from_config_update_transport_contract_summaries():
    lifecycle_control_contract_set = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_update_transport_contract_count": 0,
    ...
    assert summary == {
        ...
        "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
        "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 0,
        "manual_hold_adaptive_control_agent_lifecycle_control_contract_count": 1,
        "deferred_adaptive_control_agent_lifecycle_control_contract_count": 0,
        "adaptive_control_agent_lifecycle_control_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_defaults_to_deferred_paths_from_config_update_transport_contract_summaries():
    lifecycle_control_contract_set = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_update_transport_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary({})
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary({
        "adaptive_control_config_update_transport_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    lifecycle_control_contract_set = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_config_update_transport_contract_count": 0,
    ...
    assert lifecycle_control_contract_set["adaptive_control_agent_lifecycle_control_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["deferred_adaptive_control_agent_lifecycle_control_contract_count"] == 1
    assert summary["adaptive_control_agent_lifecycle_control_contract_summary_version"] == 1
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_set_wraps_agent_lifecycle_control_contract_summaries_cleanly():
    agent_lifecycle_control_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
        "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 1,
        "manual_hold_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_health_readiness_observability_contract_set(
        [agent_lifecycle_control_contract_summary]
    )

    assert result == {
        "adaptive_control_agent_lifecycle_control_contract_summaries": [agent_lifecycle_control_contract_summary],
        "adaptive_control_health_readiness_observability_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_set_filters_non_mapping_entries():
    agent_lifecycle_control_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_agent_lifecycle_control_contract_count": 1,
        "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_health_readiness_observability_contract_set(
        [agent_lifecycle_control_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_health_readiness_observability_contract_set(None)
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
        "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_agent_lifecycle_control_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_set_preserves_multiple_agent_lifecycle_control_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_agent_lifecycle_control_contract_count": 1,
        "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([first, second])

    assert result == {
        "adaptive_control_agent_lifecycle_control_contract_summaries": [first, second],
        "adaptive_control_health_readiness_observability_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_counts_shadow_paths_from_agent_lifecycle_control_contract_summaries():
    health_readiness_observability_contract_set = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_agent_lifecycle_control_contract_count": 1,
            "primary_cutover_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    summary = build_policy_selection_adaptive_control_health_readiness_observability_contract_summary(health_readiness_observability_contract_set)

    assert summary == {
        "summary_count": 1,
        "shadow_adaptive_control_health_readiness_observability_contract_count": 1,
        ...
        "deferred_adaptive_control_health_readiness_observability_contract_count": 0,
        "adaptive_control_health_readiness_observability_contract_summary_version": 1,
    }



def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_counts_primary_cutover_paths_from_agent_lifecycle_control_contract_summaries():
    health_readiness_observability_contract_set = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    assert summary == {
        ...
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 1,
        "manual_hold_adaptive_control_health_readiness_observability_contract_count": 0,
        "deferred_adaptive_control_health_readiness_observability_contract_count": 0,
        "adaptive_control_health_readiness_observability_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_counts_manual_hold_paths_from_agent_lifecycle_control_contract_summaries():
    health_readiness_observability_contract_set = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    assert summary == {
        ...
        "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 0,
        "manual_hold_adaptive_control_health_readiness_observability_contract_count": 1,
        "deferred_adaptive_control_health_readiness_observability_contract_count": 0,
        "adaptive_control_health_readiness_observability_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_defaults_to_deferred_paths_from_agent_lifecycle_control_contract_summaries():
    health_readiness_observability_contract_set = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_health_readiness_observability_contract_summary({})
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_health_readiness_observability_contract_summary({
        "adaptive_control_agent_lifecycle_control_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    health_readiness_observability_contract_set = build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_agent_lifecycle_control_contract_count": 0,
    ...
    assert health_readiness_observability_contract_set["adaptive_control_health_readiness_observability_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["deferred_adaptive_control_health_readiness_observability_contract_count"] == 1
    assert summary["adaptive_control_health_readiness_observability_contract_summary_version"] == 1



def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_chain_progresses_agent_lifecycle_control_contract_outputs_end_to_end():
    agent_lifecycle_control_contract_summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary(
        build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_update_transport_contract_count": 0,
    ...
    assert health_readiness_observability_contract_set == {
        "adaptive_control_agent_lifecycle_control_contract_summaries": [agent_lifecycle_control_contract_summary],
        "adaptive_control_health_readiness_observability_contract_set_version": 1,
    }
    assert health_readiness_observability_contract_summary == {
        "summary_count": 1,
        "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 1,
        "manual_hold_adaptive_control_health_readiness_observability_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_chain_handles_mixed_health_readiness_observability_path_counts():
    first_agent_lifecycle_control_contract_summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary(
        build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_update_transport_contract_count": 1,
    ...
    second_agent_lifecycle_control_contract_summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary(
        build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
            {
                "summary_count": 1,
                "shadow_adaptive_control_config_update_transport_contract_count": 0,
    ...
    health_readiness_observability_contract_summary = build_policy_selection_adaptive_control_health_readiness_observability_contract_summary(
        build_policy_selection_adaptive_control_health_readiness_observability_contract_set([
            first_agent_lifecycle_control_contract_summary,
            second_agent_lifecycle_control_contract_summary,
        ])
    )
...
def test_build_policy_selection_adaptive_control_health_readiness_observability_contract_summary_chain_preserves_deferred_counts_for_downstream_export():
    agent_lifecycle_control_contract_summary = build_policy_selection_adaptive_control_agent_lifecycle_control_contract_summary(
        build_policy_selection_adaptive_control_agent_lifecycle_control_contract_set([
            {
                "summary_count": 1,
    ...
    assert health_readiness_observability_contract_summary["summary_count"] == 1
    assert health_readiness_observability_contract_summary["deferred_adaptive_control_health_readiness_observability_contract_count"] == 1
    assert health_readiness_observability_contract_summary["adaptive_control_health_readiness_observability_contract_summary_version"] == 1



def test_extract_policy_selection_adaptive_control_health_readiness_observability_contract_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    health_readiness_observability_contract_set = {
        "adaptive_control_agent_lifecycle_control_contract_summaries": [
            {
                "summary_count": 1,
    ...
    exported = extract_policy_selection_adaptive_control_health_readiness_observability_contract_summaries([
        None,
        "skip",
        health_readiness_observability_contract_set,
    ])
...
def test_extract_policy_selection_adaptive_control_health_readiness_observability_contract_summaries_preserves_deferred_counts_for_export():
    health_readiness_observability_contract_set = {
        "adaptive_control_agent_lifecycle_control_contract_summaries": [
            {
                "summary_count": 1,
    ...
    exported = extract_policy_selection_adaptive_control_health_readiness_observability_contract_summaries([health_readiness_observability_contract_set])
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set_wraps_health_readiness_observability_contract_summaries_cleanly():
    ...
    result = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set(
        [health_readiness_observability_contract_summary]
    )
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set_filters_non_mapping_entries():
    health_readiness_observability_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_health_readiness_observability_contract_count": 1,
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set(
        [health_readiness_observability_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set(None)
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_health_readiness_observability_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set_preserves_multiple_health_readiness_observability_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_health_readiness_observability_contract_count": 1,
        "primary_cutover_adaptive_control_health_readiness_observability_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([first, second])

    assert result == {
        "adaptive_control_health_readiness_observability_contract_summaries": [first, second],
        "adaptive_control_dashboard_status_aggregation_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_counts_shadow_paths_from_health_readiness_observability_contract_summaries():
    ...
    summary = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary(dashboard_status_aggregation_contract_set)
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_counts_primary_cutover_paths_from_health_readiness_observability_contract_summaries():
    dashboard_status_aggregation_contract_set = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_counts_manual_hold_paths_from_health_readiness_observability_contract_summaries():
    dashboard_status_aggregation_contract_set = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
    ...
    assert summary == {
        ...
        "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
        "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
        "manual_hold_adaptive_control_dashboard_status_aggregation_contract_count": 1,
        "deferred_adaptive_control_dashboard_status_aggregation_contract_count": 0,
        "adaptive_control_dashboard_status_aggregation_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_defaults_to_deferred_paths_from_health_readiness_observability_contract_summaries():
    dashboard_status_aggregation_contract_set = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary({})
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary({
        "adaptive_control_health_readiness_observability_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    dashboard_status_aggregation_contract_set = build_policy_selection_adaptive_control_dashboard_status_aggregation_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_health_readiness_observability_contract_count": 0,
    ...
    assert dashboard_status_aggregation_contract_set["adaptive_control_dashboard_status_aggregation_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["deferred_adaptive_control_dashboard_status_aggregation_contract_count"] == 1
    assert summary["adaptive_control_dashboard_status_aggregation_contract_summary_version"] == 1
...
def test_extract_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    dashboard_status_aggregation_contract_set = {
        "adaptive_control_health_readiness_observability_contract_summaries": [
            {
                "summary_count": 1,
    ...
    exported = extract_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summaries([
        None,
        "skip",
        dashboard_status_aggregation_contract_set,
    ])
...
def test_extract_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summaries_preserves_deferred_counts_for_export():
    dashboard_status_aggregation_contract_set = {
        "adaptive_control_health_readiness_observability_contract_summaries": [
            {
                "summary_count": 1,
    ...
    exported = extract_policy_selection_adaptive_control_dashboard_status_aggregation_contract_summaries([dashboard_status_aggregation_contract_set])
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_set_wraps_dashboard_status_aggregation_contract_summaries_cleanly():
    dashboard_status_aggregation_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
        "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 1,
        "manual_hold_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_notification_delivery_contract_set(
        [dashboard_status_aggregation_contract_summary]
    )

    assert result == {
        "adaptive_control_dashboard_status_aggregation_contract_summaries": [dashboard_status_aggregation_contract_summary],
        "adaptive_control_notification_delivery_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_notification_delivery_contract_set_filters_non_mapping_entries():
    dashboard_status_aggregation_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 1,
        "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_notification_delivery_contract_set(
        [dashboard_status_aggregation_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_notification_delivery_contract_set(None)
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
        "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_notification_delivery_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_dashboard_status_aggregation_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_set_preserves_multiple_dashboard_status_aggregation_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 1,
        "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_notification_delivery_contract_set([first, second])

    assert result == {
        "adaptive_control_dashboard_status_aggregation_contract_summaries": [first, second],
        "adaptive_control_notification_delivery_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_counts_shadow_paths_from_dashboard_status_aggregation_contract_summaries():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 1,
            "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    summary = build_policy_selection_adaptive_control_notification_delivery_contract_summary(notification_delivery_contract_set)

    assert summary == {
        "summary_count": 1,
        "shadow_adaptive_control_notification_delivery_contract_count": 1,
        ...
        "deferred_adaptive_control_notification_delivery_contract_count": 0,
        "adaptive_control_notification_delivery_contract_summary_version": 1,
    }



def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_counts_primary_cutover_paths_from_dashboard_status_aggregation_contract_summaries():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    assert summary == {
        ...
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 1,
        "manual_hold_adaptive_control_notification_delivery_contract_count": 0,
        "deferred_adaptive_control_notification_delivery_contract_count": 0,
        "adaptive_control_notification_delivery_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_counts_manual_hold_paths_from_dashboard_status_aggregation_contract_summaries():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    assert summary == {
        ...
        "shadow_adaptive_control_notification_delivery_contract_count": 0,
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 0,
        "manual_hold_adaptive_control_notification_delivery_contract_count": 1,
        "deferred_adaptive_control_notification_delivery_contract_count": 0,
        "adaptive_control_notification_delivery_contract_summary_version": 1,
    }
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_defaults_to_deferred_paths_from_dashboard_status_aggregation_contract_summaries():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_notification_delivery_contract_summary({})
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_notification_delivery_contract_summary({
        "adaptive_control_dashboard_status_aggregation_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_notification_delivery_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    assert notification_delivery_contract_set["adaptive_control_notification_delivery_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["deferred_adaptive_control_notification_delivery_contract_count"] == 1
    assert summary["adaptive_control_notification_delivery_contract_summary_version"] == 1



def test_extract_policy_selection_adaptive_control_notification_delivery_contract_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    set_a = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 1,
            "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    set_b = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
            "primary_cutover_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    exported = extract_policy_selection_adaptive_control_notification_delivery_contract_summaries([set_a, None, "skip", set_b])
...
def test_extract_policy_selection_adaptive_control_notification_delivery_contract_summaries_uses_summary_builder_internally():
    notification_delivery_contract_set = build_policy_selection_adaptive_control_notification_delivery_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_dashboard_status_aggregation_contract_count": 0,
    ...
    exported = extract_policy_selection_adaptive_control_notification_delivery_contract_summaries([notification_delivery_contract_set])
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_set_wraps_notification_delivery_contract_summaries_cleanly():
    notification_delivery_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_notification_delivery_contract_count": 0,
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 1,
        "manual_hold_adaptive_control_notification_delivery_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_alert_dispatch_contract_set(
        [notification_delivery_contract_summary]
    )

    assert result == {
        "adaptive_control_notification_delivery_contract_summaries": [notification_delivery_contract_summary],
        "adaptive_control_alert_dispatch_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_alert_dispatch_contract_set_filters_non_mapping_entries():
    notification_delivery_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_notification_delivery_contract_count": 1,
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_alert_dispatch_contract_set(
        [notification_delivery_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_alert_dispatch_contract_set(None)
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_notification_delivery_contract_count": 0,
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_alert_dispatch_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_notification_delivery_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_set_preserves_multiple_notification_delivery_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_notification_delivery_contract_count": 1,
        "primary_cutover_adaptive_control_notification_delivery_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_alert_dispatch_contract_set([first, second])

    assert result == {
        "adaptive_control_notification_delivery_contract_summaries": [first, second],
        "adaptive_control_alert_dispatch_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_counts_shadow_paths_from_notification_delivery_contract_summaries():
    alert_dispatch_contract_set = build_policy_selection_adaptive_control_alert_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_notification_delivery_contract_count": 1,
            "primary_cutover_adaptive_control_notification_delivery_contract_count": 0,
    ...
    summary = build_policy_selection_adaptive_control_alert_dispatch_contract_summary(alert_dispatch_contract_set)
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_counts_primary_cutover_paths_from_notification_delivery_contract_summaries():
    alert_dispatch_contract_set = build_policy_selection_adaptive_control_alert_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_notification_delivery_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_counts_manual_hold_paths_from_notification_delivery_contract_summaries():
    alert_dispatch_contract_set = build_policy_selection_adaptive_control_alert_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_notification_delivery_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_defaults_to_deferred_paths_from_notification_delivery_contract_summaries():
    alert_dispatch_contract_set = build_policy_selection_adaptive_control_alert_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_notification_delivery_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_alert_dispatch_contract_summary({})
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_alert_dispatch_contract_summary({
        "adaptive_control_notification_delivery_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_alert_dispatch_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    alert_dispatch_contract_set = build_policy_selection_adaptive_control_alert_dispatch_contract_set([
        {
            "summary_count": 1,
            "shadow_adaptive_control_notification_delivery_contract_count": 0,
    ...
    assert alert_dispatch_contract_set["adaptive_control_alert_dispatch_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["deferred_adaptive_control_alert_dispatch_contract_count"] == 1
    assert summary["adaptive_control_alert_dispatch_contract_summary_version"] == 1



def test_build_policy_selection_adaptive_control_trade_execution_contract_set_wraps_alert_dispatch_contract_summaries_cleanly():
    alert_dispatch_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_alert_dispatch_contract_count": 0,
        "primary_cutover_adaptive_control_alert_dispatch_contract_count": 1,
        "manual_hold_adaptive_control_alert_dispatch_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_trade_execution_contract_set(
        [alert_dispatch_contract_summary]
    )

    assert result == {
        "adaptive_control_alert_dispatch_contract_summaries": [alert_dispatch_contract_summary],
        "adaptive_control_trade_execution_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_trade_execution_contract_set_filters_non_mapping_entries():
    alert_dispatch_contract_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_alert_dispatch_contract_count": 1,
        "primary_cutover_adaptive_control_alert_dispatch_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_trade_execution_contract_set(
        [alert_dispatch_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_trade_execution_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_trade_execution_contract_set(None)
...
def test_build_policy_selection_adaptive_control_trade_execution_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "shadow_adaptive_control_alert_dispatch_contract_count": 0,
        "primary_cutover_adaptive_control_alert_dispatch_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_trade_execution_contract_set([source_summary])
    source_summary["manual_hold_adaptive_control_alert_dispatch_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_trade_execution_contract_set_preserves_multiple_alert_dispatch_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "shadow_adaptive_control_alert_dispatch_contract_count": 1,
        "primary_cutover_adaptive_control_alert_dispatch_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_trade_execution_contract_set([first, second])
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_set_wraps_trade_execution_contract_summaries_cleanly():
    trade_execution_contract_summary = {
        "summary_count": 1,
        "paper_trade_adaptive_control_trade_execution_contract_count": 0,
        "sandbox_trade_adaptive_control_trade_execution_contract_count": 1,
        "live_trade_adaptive_control_trade_execution_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_order_placement_contract_set(
        [trade_execution_contract_summary]
    )

    assert result == {
        "adaptive_control_trade_execution_contract_summaries": [trade_execution_contract_summary],
        "adaptive_control_exchange_order_placement_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_set_filters_non_mapping_entries():
    trade_execution_contract_summary = {
        "summary_count": 1,
        "paper_trade_adaptive_control_trade_execution_contract_count": 1,
        "sandbox_trade_adaptive_control_trade_execution_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_order_placement_contract_set(
        [trade_execution_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_exchange_order_placement_contract_set(None)
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "paper_trade_adaptive_control_trade_execution_contract_count": 0,
        "sandbox_trade_adaptive_control_trade_execution_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([source_summary])
    source_summary["live_trade_adaptive_control_trade_execution_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_set_preserves_multiple_trade_execution_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "paper_trade_adaptive_control_trade_execution_contract_count": 1,
        "sandbox_trade_adaptive_control_trade_execution_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([first, second])

    assert result == {
        "adaptive_control_trade_execution_contract_summaries": [first, second],
        "adaptive_control_exchange_order_placement_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_counts_pending_submission_paths_from_trade_execution_contract_summaries():
    order_placement_contract_set = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([
        {
            "summary_count": 1,
            "paper_trade_adaptive_control_trade_execution_contract_count": 1,
            "sandbox_trade_adaptive_control_trade_execution_contract_count": 0,
    ...
    summary = build_policy_selection_adaptive_control_exchange_order_placement_contract_summary(order_placement_contract_set)
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_counts_acknowledged_paths_from_trade_execution_contract_summaries():
    order_placement_contract_set = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([
        {
            "summary_count": 1,
            "paper_trade_adaptive_control_trade_execution_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_counts_live_trade_paths_as_fully_filled():
    order_placement_contract_set = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([
        {
            "summary_count": 1,
            "paper_trade_adaptive_control_trade_execution_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_counts_rejected_paths_as_rejected_by_exchange():
    order_placement_contract_set = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([
        {
            "summary_count": 1,
            "paper_trade_adaptive_control_trade_execution_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_exchange_order_placement_contract_summary({})
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_exchange_order_placement_contract_summary({
        "adaptive_control_trade_execution_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_exchange_order_placement_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    order_placement_contract_set = build_policy_selection_adaptive_control_exchange_order_placement_contract_set([
        {
            "summary_count": 1,
            "paper_trade_adaptive_control_trade_execution_contract_count": 1,
    ...
    assert order_placement_contract_set["adaptive_control_exchange_order_placement_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["pending_submission_adaptive_control_exchange_order_placement_contract_count"] == 1
    assert summary["adaptive_control_exchange_order_placement_contract_summary_version"] == 1



def test_build_policy_selection_adaptive_control_exchange_authentication_contract_set_wraps_exchange_order_placement_contract_summaries_cleanly():
    exchange_order_placement_contract_summary = {
        "summary_count": 1,
        "pending_submission_adaptive_control_exchange_order_placement_contract_count": 0,
        "acknowledged_adaptive_control_exchange_order_placement_contract_count": 1,
        "rejected_by_exchange_adaptive_control_exchange_order_placement_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_authentication_contract_set(
        [exchange_order_placement_contract_summary]
    )

    assert result == {
        "adaptive_control_exchange_order_placement_contract_summaries": [exchange_order_placement_contract_summary],
        "adaptive_control_exchange_authentication_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_exchange_authentication_contract_set_filters_non_mapping_entries():
    exchange_order_placement_contract_summary = {
        "summary_count": 1,
        "pending_submission_adaptive_control_exchange_order_placement_contract_count": 1,
        "acknowledged_adaptive_control_exchange_order_placement_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_authentication_contract_set(
        [exchange_order_placement_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_exchange_authentication_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_exchange_authentication_contract_set(None)
...
def test_build_policy_selection_adaptive_control_exchange_authentication_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "pending_submission_adaptive_control_exchange_order_placement_contract_count": 0,
        "acknowledged_adaptive_control_exchange_order_placement_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_authentication_contract_set([source_summary])
    source_summary["fully_filled_adaptive_control_exchange_order_placement_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_exchange_authentication_contract_set_preserves_multiple_exchange_order_placement_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "pending_submission_adaptive_control_exchange_order_placement_contract_count": 1,
        "acknowledged_adaptive_control_exchange_order_placement_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_authentication_contract_set([first, second])
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_counts_vault_lookup_pending_paths_from_exchange_authentication_contract_summaries():
    credential_wiring_contract_set = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_set([
        {
            "summary_count": 1,
            "pending_auth_adaptive_control_exchange_authentication_contract_count": 1,
            "authenticated_adaptive_control_exchange_authentication_contract_count": 0,
    ...
    summary = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary(credential_wiring_contract_set)
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_counts_credential_resolved_paths_from_authenticated_contracts():
    credential_wiring_contract_set = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_set([
        {
            "summary_count": 1,
            "pending_auth_adaptive_control_exchange_authentication_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_counts_auth_failed_as_vault_lookup_failed():
    credential_wiring_contract_set = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_set([
        {
            "summary_count": 1,
            "pending_auth_adaptive_control_exchange_authentication_contract_count": 0,
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_counts_credential_expired_as_vault_lookup_failed():
    credential_wiring_contract_set = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_set([
        {
            "summary_count": 1,
            "pending_auth_adaptive_control_exchange_authentication_contract_count": 0,
            ...
            "auth_failed_adaptive_control_exchange_authentication_contract_count": 0,
            "rate_limited_adaptive_control_exchange_authentication_contract_count": 0,
            "credential_expired_adaptive_control_exchange_authentication_contract_count": 1,
            "adaptive_control_exchange_authentication_contract_summary_version": 1,
        }
    ])
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_handles_empty_inputs():
    summary = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary({})
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_skips_non_comparable_entries():
    summary = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary({
        "adaptive_control_exchange_authentication_contract_summaries": [
            None,
            "skip",
...
def test_build_policy_selection_adaptive_control_exchange_credential_wiring_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    credential_wiring_contract_set = build_policy_selection_adaptive_control_exchange_credential_wiring_contract_set([
        {
            "summary_count": 1,
            "pending_auth_adaptive_control_exchange_authentication_contract_count": 0,
    ...
    assert credential_wiring_contract_set["adaptive_control_exchange_credential_wiring_contract_set_version"] == 1
    assert summary["summary_count"] == 1
    assert summary["credential_resolved_adaptive_control_exchange_credential_wiring_contract_count"] == 1
    assert summary["adaptive_control_exchange_credential_wiring_contract_summary_version"] == 1



def test_build_policy_selection_adaptive_control_exchange_http_transport_contract_set_wraps_exchange_credential_wiring_contract_summaries_cleanly():
    credential_wiring_contract_summary = {
        "summary_count": 1,
        "vault_lookup_pending_adaptive_control_exchange_credential_wiring_contract_count": 0,
        "credential_resolved_adaptive_control_exchange_credential_wiring_contract_count": 1,
        "auth_flow_initiated_adaptive_control_exchange_credential_wiring_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_http_transport_contract_set(
        [credential_wiring_contract_summary]
    )

    assert result == {
        "adaptive_control_exchange_credential_wiring_contract_summaries": [credential_wiring_contract_summary],
        "adaptive_control_exchange_http_transport_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_exchange_http_transport_contract_set_filters_non_mapping_entries():
    credential_wiring_contract_summary = {
        "summary_count": 1,
        "vault_lookup_pending_adaptive_control_exchange_credential_wiring_contract_count": 1,
        "credential_resolved_adaptive_control_exchange_credential_wiring_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_http_transport_contract_set(
        [credential_wiring_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_exchange_http_transport_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_exchange_http_transport_contract_set(None)
...
def test_build_policy_selection_adaptive_control_exchange_http_transport_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "vault_lookup_pending_adaptive_control_exchange_credential_wiring_contract_count": 0,
        "credential_resolved_adaptive_control_exchange_credential_wiring_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_http_transport_contract_set([source_summary])
    source_summary["vault_lookup_failed_adaptive_control_exchange_credential_wiring_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_exchange_http_transport_contract_set_preserves_multiple_exchange_credential_wiring_contract_summaries_in_order():
    first = {
        "summary_count": 1,
        "vault_lookup_pending_adaptive_control_exchange_credential_wiring_contract_count": 1,
        "credential_resolved_adaptive_control_exchange_credential_wiring_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_http_transport_contract_set([first, second])
...
def test_build_policy_selection_adaptive_control_exchange_response_handling_contract_set_wraps_exchange_http_transport_contract_summaries_cleanly():
    http_transport_contract_summary = {
        "summary_count": 1,
        "pending_transport_adaptive_control_exchange_http_transport_contract_count": 0,
        "request_built_adaptive_control_exchange_http_transport_contract_count": 1,
        "response_received_adaptive_control_exchange_http_transport_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set(
        [http_transport_contract_summary]
    )

    assert result == {
        "adaptive_control_exchange_http_transport_contract_summaries": [http_transport_contract_summary],
        "adaptive_control_exchange_response_handling_contract_set_version": 1,
    }



def test_build_policy_selection_adaptive_control_exchange_response_handling_contract_set_filters_non_mapping_entries():
    http_transport_contract_summary = {
        "summary_count": 1,
        "pending_transport_adaptive_control_exchange_http_transport_contract_count": 1,
        "request_built_adaptive_control_exchange_http_transport_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set(
        [http_transport_contract_summary, None, "skip", 7]
    )
...
def test_build_policy_selection_adaptive_control_exchange_response_handling_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set(None)
...
def test_build_policy_selection_adaptive_control_exchange_response_handling_contract_set_copies_summary_entries():
    source_summary = {
        "summary_count": 1,
        "pending_transport_adaptive_control_exchange_http_transport_contract_count": 0,
        "request_built_adaptive_control_exchange_http_transport_contract_count": 0,
    ...
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set([source_summary])
    source_summary["transport_failed_adaptive_control_exchange_http_transport_contract_count"] = 99
...
def test_build_policy_selection_adaptive_control_exchange_response_handling_contract_set_preserves_multiple_exchange_http_transport_contract_summaries_in_order():
    transport_summary_1 = build_policy_selection_adaptive_control_exchange_http_transport_contract_summary({
        "adaptive_control_exchange_credential_wiring_contract_summaries": [],
        "adaptive_control_exchange_http_transport_contract_set_version": 1,
    })
    transport_summary_2 = build_policy_selection_adaptive_control_exchange_http_transport_contract_summary({
        "adaptive_control_exchange_credential_wiring_contract_summaries": [],
        "adaptive_control_exchange_http_transport_contract_set_version": 2,
    })
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set([transport_summary_1, transport_summary_2])
    assert result["adaptive_control_exchange_http_transport_contract_summaries"][0]["adaptive_control_exchange_http_transport_contract_summary_version"] == 1
    assert result["adaptive_control_exchange_http_transport_contract_summaries"][1]["adaptive_control_exchange_http_transport_contract_summary_version"] == 2



def test_build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set_wraps_exchange_response_handling_contract_summaries_cleanly():
    response_handling_summary = build_policy_selection_adaptive_control_exchange_response_handling_contract_summary({
        "adaptive_control_exchange_http_transport_contract_summaries": [],
        "adaptive_control_exchange_response_handling_contract_set_version": 1,
    })
    result = build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set([response_handling_summary])
    assert result["adaptive_control_exchange_execution_confirmation_contract_set_version"] == 1
    assert result["adaptive_control_exchange_response_handling_contract_summaries"] == [response_handling_summary]


def test_build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set_filters_non_mapping_entries():
    response_handling_summary = build_policy_selection_adaptive_control_exchange_response_handling_contract_summary({
        "adaptive_control_exchange_http_transport_contract_summaries": [],
        "adaptive_control_exchange_response_handling_contract_set_version": 1,
    })
    result = build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set([None, response_handling_summary, "string"])
    assert result["adaptive_control_exchange_response_handling_contract_summaries"] == [response_handling_summary]


def test_build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set_defaults_to_empty_summary_list():
    result = build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set([])
    assert result["adaptive_control_exchange_response_handling_contract_summaries"] == []
    assert result["adaptive_control_exchange_execution_confirmation_contract_set_version"] == 1


def test_build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set_copies_summary_entries():
    response_handling_summary = build_policy_selection_adaptive_control_exchange_response_handling_contract_summary({
        "adaptive_control_exchange_http_transport_contract_summaries": [],
        "adaptive_control_exchange_response_handling_contract_set_version": 1,
    })
    result = build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_set([response_handling_summary])
    response_handling_summary["summary_count"] = 999
    assert result["adaptive_control_exchange_response_handling_contract_summaries"][0]["summary_count"] != 999
...
def test_build_policy_selection_adaptive_control_exchange_execution_confirmation_contract_summary_round_trips_with_set_builder_and_preserves_versions():
    ...
    result = build_policy_selection_adaptive_control_exchange_response_handling_contract_set([first, second])
...
def test_extract_policy_selection_adaptive_control_config_update_transport_contract_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    ...
    exported = extract_policy_selection_adaptive_control_config_update_transport_contract_summaries([
        None,
        "skip",
        transport_contract_set,
    ])
...
def test_extract_policy_selection_adaptive_control_config_update_transport_contract_summaries_preserves_deferred_counts_for_export():
    transport_contract_set = {
        "adaptive_control_runtime_config_materialization_summaries": [
            {
                "summary_count": 1,
    ...
    exported = extract_policy_selection_adaptive_control_config_update_transport_contract_summaries([transport_contract_set])
...
def test_extract_policy_selection_adaptive_control_runtime_config_materialization_summaries_skips_invalid_sets_and_returns_direct_summary_shape():
    adaptive_control_runtime_config_materialization_summaries = extract_policy_selection_adaptive_control_runtime_config_materialization_summaries([
        None,
        "skip",
        {
            "adaptive_control_config_patch_contract_summaries": [
    ...
    assert adaptive_control_runtime_config_materialization_summaries == [
        {
            "summary_count": 1,
            "shadow_adaptive_control_runtime_config_materialization_count": 1,
            "primary_cutover_adaptive_control_runtime_config_materialization_count": 0,
...
def test_extract_policy_selection_adaptive_control_runtime_config_materialization_summaries_preserves_deferred_counts_for_export():
    adaptive_control_runtime_config_materialization_summaries = extract_policy_selection_adaptive_control_runtime_config_materialization_summaries([
        {
            "adaptive_control_config_patch_contract_summaries": [
                {
