...
def test_validate_asset_pair_format():
    ...
    assert validate_asset_pair_format('BTC') is False  # too short (default min_length=6)
    assert validate_asset_pair_format('BTCUS') is False  # too short (default min_length=6)
