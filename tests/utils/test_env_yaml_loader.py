...
class TestRealWorldScenarios:
    ...
    def test_ffe_config_loading(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setenv("ALPHA_VANTAGE_API_KEY", "REDACTED_ALPHAVANTAGE_KEY")
        monkeypatch.setenv("COINBASE_API_KEY", "organizations/97bc271d-9497-424e/apiKeys/01409727")
        monkeypatch.setenv("COINBASE_API_SECRET", "-----BEGIN EC PRIVATE KEY REDACTED-----\nMHc...")
        monkeypatch.setenv("OANDA_API_KEY", "REDACTED_OANDA_TOKEN_PREFIX")
...
'''
        ...
        assert config["alpha_vantage_api_key"] == "REDACTED_ALPHAVANTAGE_KEY"
        ...
        assert config["platforms"][1]["credentials"]["api_key"] == "REDACTED_OANDA_TOKEN_PREFIX"
