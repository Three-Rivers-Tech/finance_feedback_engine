...
def test_risk_context_fields():
    ...
    assert 'correlation_summary' in decision, "Decision missing correlation_summary field"
    ...
    if retrieved:
        ...
        assert 'correlation_alerts' in retrieved, "Persisted decision missing correlation_alerts"
