...
class TestValidateTradeCorrelation:
    ...
    def test_low_correlation_passes(self, mock_schedule, risk_gatekeeper):
        ...
        context = {
            ...
            'correlation_analysis': {
                'coinbase': {
                    'concentration_warning': None  # No warning
                }
            }
        }
    ...
    @patch('finance_feedback_engine.risk.gatekeeper.MarketSchedule')
    def test_legacy_correlation_check_without_analysis(self, mock_schedule, risk_gatekeeper):
        ...
        context = {
            ...
            'holdings': {
                'BTC': 'crypto',
                'ETH': 'crypto'  # Already at limit of 2
            }
        }
...
class TestValidateTradeVaR:
    ...
    def test_var_exceeds_limit_fails(self, mock_schedule, risk_gatekeeper):
        ...
        context = {
            ...
            'var_analysis': {
                'combined_var': {
                    'var': 0.06  # 6% VaR (exceeds 5% limit)
                }
            }
        }
...
class TestValidateTradeVolatilityConfidence:
    ...
    @patch('finance_feedback_engine.risk.gatekeeper.MarketSchedule')
    def test_low_volatility_high_confidence_passes(self, mock_schedule, risk_gatekeeper):
    ...
    @patch('finance_feedback_engine.risk.gatekeeper.MarketSchedule')
    def test_high_volatility_high_confidence_passes(self, mock_schedule, risk_gatekeeper):
...
class TestComprehensiveValidation:
    ...
    def test_all_checks_pass(self, mock_schedule, risk_gatekeeper):
        ...
        context = {
            ...
            'var_analysis': {
                'combined_var': {'var': 0.03}  # VaR under limit
            },
            'correlation_analysis': {
    ...
    @patch('finance_feedback_engine.risk.gatekeeper.MarketSchedule')
    def test_multiple_failures_returns_first_failure(self, mock_schedule, risk_gatekeeper):
