...
class TestMinConfidenceThresholdBackwardCompatibility:
    ...
    def test_comparison_with_decision_confidence(self):
        ...
        assert (
            decision_confidence_pass / 100.0
        ) >= config.min_confidence_threshold  # 0.75 >= 0.70: True
        assert (
            decision_confidence_fail / 100.0
        ) < config.min_confidence_threshold  # 0.65 < 0.70: True
...
class TestMinConfidenceThresholdIntegration:
    ...
    def test_confidence_comparison_logic(self):
        ...
        should_execute_high = (
            confidence_normalized_high >= config.min_confidence_threshold
        )
        ...
        should_execute_low = (
            confidence_normalized_low >= config.min_confidence_threshold
        )
        ...
        should_execute_exact = (
            confidence_normalized_exact >= config.min_confidence_threshold
        )
