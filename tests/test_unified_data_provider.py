...
def mock_candles():
    ...
    return [
        {"timestamp": "2025-12-03T10:00:00Z", "open": 42000, "high": 42100, "low": 41900, "close": 42050, "volume": 100},
        {"timestamp": "2025-12-03T10:01:00Z", "open": 42050, "high": 42200, "low": 42000, "close": 42150, "volume": 150},
        {"timestamp": "2025-12-03T10:02:00Z", "open": 42150, "high": 42300, "low": 42100, "close": 42250, "volume": 200},
    ]
...
class TestUnifiedDataProviderAggregation:
    ...
    def test_aggregate_all_timeframes_basic(self, mock_config, mock_candles):
        ...
        with patch.object(provider, 'get_multi_timeframe_data') as mock_get:
            ...
            for tf in ['1m', '5m', '15m', '1h', '4h', '1d']:
                ...
                assert result["timeframes"][tf]["source_provider"] in ['coinbase', 'alpha_vantage']
    ...
    def test_aggregate_with_missing_data(self, mock_config, mock_candles):
        ...
        with patch.object(provider, 'get_multi_timeframe_data') as mock_get:
            ...
            result = provider.aggregate_all_timeframes("BTCUSD", timeframes=['1m', '5m', '15m'])
    ...
    def test_aggregate_metadata_tracking(self, mock_config, mock_candles):
        ...
        with patch.object(provider, 'get_multi_timeframe_data') as mock_get:
            ...
            result = provider.aggregate_all_timeframes("BTCUSD", timeframes=['1m', '5m', '1h'])
    ...
    def test_aggregate_empty_timeframes(self, mock_config):
        ...
        with patch.object(provider, 'get_multi_timeframe_data') as mock_get:
            ...
            result = provider.aggregate_all_timeframes("BTCUSD", timeframes=['1m', '5m'])
