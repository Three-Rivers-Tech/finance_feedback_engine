...
def mock_coinbase_client():
    ...
    type(futures_summary_response).balance_summary = PropertyMock(return_value={
    ...
    type(futures_positions_response).positions = PropertyMock(return_value=[
        {
    ...
    type(usd_account).available_balance = PropertyMock(return_value=available_balance_usd)
    ...
    type(usdc_account).available_balance = PropertyMock(return_value=available_balance_usdc)
    ...
    type(btc_account).available_balance = PropertyMock(return_value=available_balance_btc)

    type(spot_accounts_response).accounts = PropertyMock(return_value=[
        usd_account, usdc_account, btc_account
    ])
