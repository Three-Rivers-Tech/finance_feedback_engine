...
echo "----------------------------"
python main.py -c config/examples/test.yaml analyze ETHUSD
echo ""

echo "4. Check Account Balance"
echo "------------------------"
python main.py -c config/examples/test.yaml balance
echo ""

echo "5. View Decision History"
echo "------------------------"
python main.py -c config/examples/test.yaml history --limit 5
echo ""
