...
from finance_feedback_engine.monitoring import TradeMetricsCollector, TradeMonitor
...
def main():
    ...
    engine.enable_monitoring_integration(
        trade_monitor=trade_monitor, metrics_collector=metrics_collector
    )
    ...
    print(
        f"  Available: {trade_monitor.MAX_CONCURRENT_TRADES - len(trade_monitor.active_trackers)}"
    )
